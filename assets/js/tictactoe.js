...
$(document).ready(function () {
    ...
    $(".box").click(function () {
        ...
        if (gamestatus == "cont" && vagainst == "computer") {
            ...
            setTimeout(function () {
                gamearea.executeStep(availableboxes[randomboxid]);
            }, 300);
        }
    });
...
gamearea = {
    ...
    gameLogic: function (selectedid, setvalue) {
        ...
        $.each(lvar, function () {
            ...
            if (a === b && a === c && b === c) {
                gamearea.chgColor(indexvalue[0]);
                gamearea.chgColor(indexvalue[1]);
                gamearea.chgColor(indexvalue[2]);
    ...
    player1Info: function () {
        var p1 = prompt("Please enter player 1's name", "Player 1");
        if (p1 != null) {
            //  console.log(p1);
            return p1;
        } else {
    ...
    player2Info: function () {
        var p2 = prompt("Please enter player 2's name", "Player 2");
        if (p2 != null) {
            //  console.log(p2);
            return p2;
        } else {
